...
/*
este archivo es el que se encarga de la base de datos sqlite
aqui creo la tabla y hago las funciones crud: crear leer actualizar borrar

se relaciona con:
- mainactivity: pide la lista completa para pintarla en el listview
- detailactivity: pide un monstruo concreto por id
- editmonsteractivity: llama a add o update para guardar cambios
- monster: es el objeto que devuelvo a la app cuando leo de la bd

nota:
sqliteopenhelper me obliga a implementar oncreate y onupgrade
*/
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // datos de demo para que siempre haya contenido al arrancar la primera vez
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // nota: para este feedback me vale con resetear la tabla
